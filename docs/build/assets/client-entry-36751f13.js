...
function Fj(a, b, c) {
  ...
  switch (b.tag) {
    ...
    case 19:
      ...
      if (null !== f2.tail)
        return b = f2.tail, f2.rendering = b, f2.tail = b.sibling, f2.renderingStartTime = B$1(), b.sibling = null, c = M.current, G(M, d ? c & 1 | 2 : c & 1), b;
      S(b);
      return null;
    case 22:
    case 23:
...
function mh(a, b, c, d) {
  ...
  Ac(a, c, d);
  if (0 === (K & 2) || a !== R)
    a === R && (0 === (K & 2) && (rk |= c), 4 === T && Dk(a, Z)), Ek(a, d), 1 === c && 0 === K && 0 === (b.mode & 1) && (Hj = B$1() + 500, fg && jg());
}
function Ek(a, b) {
...
function Ui(a, b, c) {
  ...
  R === a && (Z & c) === c && (4 === T || 3 === T && (Z & 130023424) === Z && 500 > B$1() - gk ? Lk(a, 0) : sk |= c);
  Ek(a, b);
}
function Zk(a, b) {
...
const configData = { "title": "123", "description": "SSG FrameWork", "themeConfig": {}, "vite": {} };
